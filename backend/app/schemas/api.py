...
class ErrorCode(str, Enum):
    ...
    MISSION_TRIGGER_INTERRUPTED = "MISSION_TRIGGER_INTERRUPTED"
    ...
    PROCEDURE_CORPUS_INVALID = "PROCEDURE_CORPUS_INVALID"
    PROCEDURE_MANIFEST_INVALID = "PROCEDURE_MANIFEST_INVALID"
    PROCEDURE_MANUAL_NOT_FOUND = "PROCEDURE_MANUAL_NOT_FOUND"
    PROCEDURE_MANUAL_SECURITY_ERROR = "PROCEDURE_MANUAL_SECURITY_ERROR"
    PROCEDURE_MANUAL_PARSE_ERROR = "PROCEDURE_MANUAL_PARSE_ERROR"
    ...
    RETRIEVAL_INDEX_NOT_FOUND = "RETRIEVAL_INDEX_NOT_FOUND"
    RETRIEVAL_INDEX_CORRUPT = "RETRIEVAL_INDEX_CORRUPT"
    RETRIEVAL_INDEX_STALE = "RETRIEVAL_INDEX_STALE"
    RETRIEVAL_INDEX_UNAVAILABLE = "RETRIEVAL_INDEX_UNAVAILABLE"
    NVIDIA_NIM_AUTH_ERROR = "NVIDIA_NIM_AUTH_ERROR"
    NVIDIA_NIM_RATE_LIMITED = "NVIDIA_NIM_RATE_LIMITED"
    NVIDIA_NIM_TIMEOUT = "NVIDIA_NIM_TIMEOUT"
    NVIDIA_NIM_UNAVAILABLE = "NVIDIA_NIM_UNAVAILABLE"
    NVIDIA_NIM_RESPONSE_INVALID = "NVIDIA_NIM_RESPONSE_INVALID"
    RERANK_RESPONSE_INVALID = "RERANK_RESPONSE_INVALID"
    PLANNER_CONTEXT_INVALID = "PLANNER_CONTEXT_INVALID"
    PLANNER_PROMPT_TOO_LARGE = "PLANNER_PROMPT_TOO_LARGE"
    PLANNER_OUTPUT_INVALID = "PLANNER_OUTPUT_INVALID"
    PLANNER_MODEL_MISMATCH = "PLANNER_MODEL_MISMATCH"
    PLANNER_RESPONSE_INCOMPLETE = "PLANNER_RESPONSE_INCOMPLETE"
    PLANNING_NOT_AVAILABLE = "PLANNING_NOT_AVAILABLE"
    PLANNING_CONTEXT_MISMATCH = "PLANNING_CONTEXT_MISMATCH"
    PLANNING_IN_PROGRESS = "PLANNING_IN_PROGRESS"
    PLANNER_CANDIDATE_UNGROUNDED = "PLANNER_CANDIDATE_UNGROUNDED"
    PLANNING_ATTEMPT_NOT_FOUND = "PLANNING_ATTEMPT_NOT_FOUND"
    PLANNING_ATTEMPT_ALREADY_EXISTS = "PLANNING_ATTEMPT_ALREADY_EXISTS"
    PLANNING_ATTEMPT_CORRUPT = "PLANNING_ATTEMPT_CORRUPT"
    PLANNING_ATTEMPT_STORAGE_ERROR = "PLANNING_ATTEMPT_STORAGE_ERROR"
    PLANNING_ATTEMPT_ID_INVALID = "PLANNING_ATTEMPT_ID_INVALID"
    MISSION_RETRIEVAL_QUERY_TOO_LARGE = "MISSION_RETRIEVAL_QUERY_TOO_LARGE"
    PLANNING_VALIDATION_NOT_FOUND = "PLANNING_VALIDATION_NOT_FOUND"
    PLANNING_VALIDATION_ALREADY_EXISTS = "PLANNING_VALIDATION_ALREADY_EXISTS"
    PLANNING_VALIDATION_CORRUPT = "PLANNING_VALIDATION_CORRUPT"
    PLANNING_VALIDATION_CONFLICT = "PLANNING_VALIDATION_CONFLICT"
    PLANNING_VALIDATION_STORAGE_ERROR = "PLANNING_VALIDATION_STORAGE_ERROR"
    PLANNING_SIMULATION_INTEGRITY_ERROR = "PLANNING_SIMULATION_INTEGRITY_ERROR"
    PLANNING_SERVICE_UNAVAILABLE = "PLANNING_SERVICE_UNAVAILABLE"
    PLANNING_SIMULATION_CANCELLED = "PLANNING_SIMULATION_CANCELLED"
